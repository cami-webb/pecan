...
(`settings$database$bety`)) into R code like the following:
...
- - [`PEcAn.DB::get.trait.data`](https://pecanproject.github.io/package-documentation/develop/PEcAn.DB/reference/get.trait.data.html)
