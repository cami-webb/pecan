...
```{r load-settings}
settings_path <- here::here("/pecan/documentation/quarto/01_Demo_Basic_Run/pecan.xml")
```
...
# Check if the /data/dbfiles directory exists; if not, create it
if (!dir.exists("/data/dbfiles")) {
  dir.create("/data/dbfiles", recursive = TRUE)
}
# Copy the meteorological data file to the dbfiles directory
system("cp /pecan/documentation/quarto/01_Demo_Basic_Run/dbfiles/AMF_US-NR1_BASE_HH_23-5.2004-01-01.2004-12-31.clim /data/dbfiles/")
```
...
settings$pfts[[1]]$posterior.files <- "/pecan/documentation/quarto/01_Demo_Basic_Run/pft/temperate.coniferous/prior.distns.Rdata"
...
var_lookup <- read.csv("/pecan/documentation/quarto/01_Demo_Basic_Run/variable_lookup.csv", stringsAsFactors = FALSE)
