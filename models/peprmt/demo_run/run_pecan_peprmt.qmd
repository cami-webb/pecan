...
```{r}
remotes::install_github("pecanproject/pecan#3871", subdir = "base/all", ref = "develop")
remotes::install_github("abbylewis/pecan", subdir = "models/peprmt", 
                        ref = "peprmt")
```
...
model_output |>
  ...
  select("site_id", "run_id", "posix", "GPP", "NEE") |>
  pivot_longer(cols = c("GPP", "NEE"), names_to = "flux") |>
  ggplot() +
