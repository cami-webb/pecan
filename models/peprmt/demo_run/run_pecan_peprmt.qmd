...
We are modeling ____ at ____ sites. The model configuration uses the PEPRMT-Tidal process-based ecosystem model. [model details]
...
If you haven't already installed the PEPRMT R package, you can do so by running the following code. 

```{r download-peprmt}
# Install from GitHub
devtools::install_github("https://github.com/abbylewis/PEPRMT-Tidal")
```
